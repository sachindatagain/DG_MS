...
# def forecast_with_growth(data, periods=11, growth_rate=0.05, fluctuation_range=(-0.1, 0.1)): 
#     """Forecast volume with a fixed growth rate and random fluctuation."""
#     last_value = data.iloc[-1] if not data.empty else 100  # Default if empty
#     forecast = []
...
#     # Clear cache and session state to prevent stale data
#     st.cache_data.clear()
#     st.session_state.clear()

#     # Fetch data from the database
#     data = fetch_data()
#     st.write("🔍 Debug: Data Loaded", data)  # Debugging line
